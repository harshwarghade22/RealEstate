...
const ListingForm = (props) => {
    ...
    const { sale_type, price, bedrooms, home_type, bathrooms, sqft, days_listed, has_photos, keywords } = formData;
    ...
    const onSubmit = e => {
        ...
        setLoading(true);
        axios.post(`${process.env.REACT_APP_API_URL}/api/listings/search`, { sale_type, price, bedrooms, home_type, bathrooms, sqft, days_listed, has_photos, keywords }, config)
            .then(res => {
                setLoading(false);
